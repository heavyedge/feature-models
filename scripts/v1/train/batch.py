"""Load aligned CSV data with output variables as a GP batch dimension."""

import numpy as np
import pandas as pd


def load_batched_arrays(X_path, y_path, targets, index_col=None, batch_col=None):
    """Return X ``(*K, N, D)`` and y ``(*K, T, N)`` arrays."""
