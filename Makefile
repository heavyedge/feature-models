...
notebooks/CV.%.ipynb: _temp/X.csv _temp/y.csv _temp/cv.GPR_%.csv _temp/cv.CgLmcMtgpqr_%.csv _temp/cv.CgIndependentMtgpqr_%.csv FORCE
	jupyter nbconvert --to notebook --execute --inplace $@
...
_temp/cv.CgLmcMtgpqr_%.csv: scripts/model_selection/write-cv.gpqr.py _temp/X.csv _temp/y.csv
...
_temp/cv.CgIndependentMtgpqr_%.csv: scripts/model_selection/write-cv.gpqr.py _temp/X.csv _temp/y.csv
